      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:gopichandanasiri@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="gopichandanasiri@gmail.com">
            ...
            <div className="m-2">
              <a href="https://gopichandana.medium.com/" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-light" title="My other projects">
